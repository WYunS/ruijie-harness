    ...
    ctx.effect(
      () => {
        try {
          ...
          // the URL's protocol flag (browserInterceptHttp / Https — both are
          // on by default in the Ruijie desktop), and the
          ...
          return registerLinkInterception({
            ...
            openInSidebar: (url) => {
              ...
              ctx.betterSidebar?.openTab({ type, url, title, placement: 'right' })
            },
