...
export interface SidebarPrefs {
   ...
   * instead of a new browser tab. On by default for the Ruijie desktop;
   * sites that refuse iframe embedding show the existing open-in-browser
   * fallback. Gated on the `browserInterceptLinks` master and the target
