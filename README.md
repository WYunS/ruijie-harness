...
| 平台 | 下载 | 安装方式 |
| --- | --- | --- |
| Windows x64 | [下载安装程序](https://gptauth.ruijie.com.cn/harness/api/downloads/windows) | 运行 NSIS 安装程序并按提示完成安装 |
| macOS Universal | [下载 DMG](https://gptauth.ruijie.com.cn/harness/api/downloads/mac) | 打开 DMG，将 DSH Desktop 拖入 Applications |
