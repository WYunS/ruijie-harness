...
:root{color-scheme:light;font:16px/1.55 -apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif;color:#111;background:#fff}*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:24px}.completion{text-align:center;transform:translateY(-5vh)}.mark{width:72px;height:72px;margin:0 auto 26px;border:1px solid #e7e7e7;border-radius:18px;display:grid;place-items:center;color:#111;background:#fff;box-shadow:0 10px 28px #00000014;font-size:25px;font-style:italic;font-weight:850;letter-spacing:-.08em}h1{margin:0;font-size:34px;font-weight:500;line-height:1.2;letter-spacing:-.04em}p{margin:24px 0 0;color:#6f6f73;font-size:16px}@media(max-width:480px){.mark{width:64px;height:64px;border-radius:16px}h1{font-size:30px}}
</style></head><body><main class="completion"><span class="mark" aria-hidden="true">RJ</span><h1>锐捷Harness</h1><p>授权完成，关闭本页</p></main>
