...
| @huanlin/dsh-plugin-better-sidebar-plugin-office | 0.1.0 | AGPL-3.0 |
...
| @neplex/vectorizer | 0.1.0 | MIT |
| @neplex/vectorizer-win32-arm64-msvc | 0.1.0 | MIT |
| @neplex/vectorizer-win32-x64-msvc | 0.1.0 | MIT |
...
| @tencent-connect/qqbot-connector | 1.2.0 | UNLICENSED (business-approved exception) |
...
| dsh-attachment-formats | 0.6.4 | Apache-2.0 |
| dsh-better-sidebar | 0.14.0 | MIT |
| dsh-community-market | 0.1.0-dev.0 | MIT |
| dsh-office-tools | 0.1.0 | MIT |
| dsh-ui-appearance | 0.1.4 | MIT |
| dsh-vision-router | 1.7.3 | MIT |
| duck | 0.1.12 | BSD |
...
| puppeteer-core | 25.8.0 | Apache-2.0 |
| qrcode | 1.5.4 | MIT |
...
| zustand | 4.4.7 | MIT |
| zwitch | 2.0.4 | MIT |
> Notice-required licenses in use: AGPL-3.0, Apache-2.0 AND LGPL-3.0-or-later. Their license texts ship inside node_modules; see the package LICENSE files for the full terms.